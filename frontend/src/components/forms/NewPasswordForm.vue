...
<form @submit.prevent="submit" class="row g-3 mt-3 needs-validation" autocomplete="on" novalidate>
  ...
  <div class="col-md-6">
    ...
    <input autocomplete="confirm-password" name="password" id="inputPassword" type="password" class="form-control" :class="{'is-invalid': payload.password !== confirm_password, 'is-valid': payload.password === confirm_password && payload.password !== ''}" v-model="confirm_password">
