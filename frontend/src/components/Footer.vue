...
import DigitalOcean from "@/components/DigitalOcean.vue"

onMounted(() => {
  window.$("#allRightsYear").text(`© ${new Date().getFullYear()} Company, Inc. All rights reserved.`)
})
</script>
    ...
    <div class="row">
      ...
      <div class="col-md-5 offset-md-1 mb-3">
        <form>
          ...
          <div class="d-flex flex-column flex-sm-row w-100 gap-2 mb-4">
